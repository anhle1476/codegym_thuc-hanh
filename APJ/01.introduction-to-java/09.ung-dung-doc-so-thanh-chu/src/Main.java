...
public class Main {
    ...
    public static String readNormalDigit(int onesDigit) { return NORMAL_DIGIT[onesDigit]; };

    public static String readSpecialDigit(int digit) { return SPECIAL_DIGIT[digit]; };
